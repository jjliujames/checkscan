  ...
  <div class="w-full max-w-2xl">
    <div class="bg-white rounded-xl shadow-md p-8">
      <div class="flex flex-col items-center text-center">
        <h1 class="text-3xl font-bold mb-2 bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text">Image Analysis</h1>
        ...
        <div v-if="error" class="w-full max-w-lg mt-8 p-4 bg-red-50 text-red-600 rounded-lg border-l-4 border-red-500 text-center">
          {{ error }}
        </div>
      </div>
    </div>
